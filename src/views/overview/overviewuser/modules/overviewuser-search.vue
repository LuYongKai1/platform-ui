...
interface Emits {
  (e: "reset"): void;
  (e: "search", channelId: string, retentionGroupType: string, targetDay?: string | null, beginTime?: string, endTime?: string,): void;
}
...
watch(
  () => [model.value.channelId, model.value.retentionGroupType, model.value.targetDay, model.value.dateRange, ],
  () => {
