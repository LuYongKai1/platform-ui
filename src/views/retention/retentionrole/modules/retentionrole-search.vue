...
interface Emits {
  (e: "reset"): void;
  (e: "search", serverId: string, channelId: string, retentionGroupType: string, targetDay?: string | null, beginTime?: string, endTime?: string, retentionType?: string): void;
}
...
watch(
  () => [model.value.channelId, model.value.serverId, model.value.retentionGroupType, model.value.targetDay, model.value.dateRange, model.value.retentionType],
  () => {
