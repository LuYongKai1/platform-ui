...
import RetentionUserSearch from "./modules/retentionuser-search.vue";
...
const {
  ...
  apiFn: fetchGetUserRetentionList,
  showTotal: true,
  immediate: false, 
  apiParams: {
    current: 1,
  ...
  columns: () => [
    ...
    {
      key: "day1",
      title: $t("page.manage.retention.New"),
      align: "center",
      Width: 60,
    },
    {
...
// 监听数据分组变化并更新列显示状态
function handleSearch( channelId: string, retentionGroupType: string, targetDay?: string | null, beginTime?: string, endTime?: string, retentionType?: string) {
  const params: any = {
    channelId,
    retentionGroupType,
    retentionType,
